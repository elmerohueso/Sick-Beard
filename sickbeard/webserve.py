...
class ConfigSearch:
    ...
    def saveSearch(self, **postData):
        ...
        sickbeard.IGNORE_WORDS = postData.get("ignore_words")

        # NZB Search
        sickbeard.USE_NZBS = config.checkbox_to_value(postData.get("use_nzbs"))

        sickbeard.SAB_HOST = config.clean_url(postData.get("sab_host"))
        sickbeard.SAB_USERNAME = postData.get("sab_username")
        sickbeard.SAB_PASSWORD = postData.get("sab_password")
        sickbeard.SAB_APIKEY = postData.get("sab_apikey").strip()
        sickbeard.SAB_CATEGORY = postData.get("sab_category")
        ...
        sickbeard.NZBGET_HOST = config.clean_url(postData.get("nzbget_host"))
        sickbeard.NZBGET_USERNAME = postData.get("nzbget_username")
        sickbeard.NZBGET_PASSWORD = postData.get("nzbget_password")
        sickbeard.NZBGET_CATEGORY = postData.get("nzbget_category")
...
class ConfigHidden:
    ...
    @cherrypy.expose
    def saveHidden(self, anon_redirect=None, display_all_seasons=None, git_path=None, extra_scripts=None, create_missing_show_dirs=None, add_shows_wo_dir=None, ignore_words=None ):
